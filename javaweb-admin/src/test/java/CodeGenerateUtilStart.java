...
public class CodeGenerateUtilStart extends BaseTest {
    ...
    public void generateStart() throws Exception {
        ...
        /*设置表前缀，将会自动删除*/
        codeGenerateUtils.setTablePredix("entity_");
        /*设置项目根目录*/
        ...
        /*设置vue二级路径*/
        codeGenerateUtils.setView2Level("entity_dormitory");
        /*设置生成目标所在包名*/
        codeGenerateUtils.setSbPackName("com.withmore.group");
        /*设置sb子模块名*/
        codeGenerateUtils.setSubModuleName("dormitory");
        /*生成目标sql所在database名*/
        codeGenerateUtils.setDatabaseName("registration_system");
        /*生成目标sql表名*/
        codeGenerateUtils.setTableName("entity_dormitory");
        /*表注释 ，导航栏标题*/
        codeGenerateUtils.setTableAnnotation("宿舍信息表");
        /*生成*/
