...
import com.javaweb.system.shiro.filter.JwtFilter;
import com.javaweb.system.shiro.MySessionManager;
import com.javaweb.system.shiro.MyShiroRealm;
import com.javaweb.system.shiro.storage.CustomSessionStorage;
import lombok.Data;
...
//    @Value("6000")
    ...
    public SessionManager sessionManager() {
        ...
        // 自定义Subject 工厂，决定是否为登录请求生成Session
    ...
    public SecurityManager securityManager() {
        ...
        dao.setSessionStorageEvaluator(new CustomSessionStorage());
