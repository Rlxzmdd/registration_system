...
public enum ResultCodeEnum {
    ...
    FORM_DATA_IS_NOT_SUBMIT("V0303", "表单数据从未提交"),
    FORM_AUDIT_IS_NOT_FINISH("V0304", "表单未审核完结，无法修改数据"),
    FORM_AUDIT_IS_NOT_EXISTS("V0305", "表单审核请求记录不存在"),
    FORM_AUDIT_ALREADY("v0306", "表单审核请求已完成，请勿重复提交"),
    ...
    USER_ERROR_A0606("A0606", "用户图片上传至OSS异常"),
